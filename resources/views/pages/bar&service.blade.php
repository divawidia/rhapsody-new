...
@section('title')
    Bar & Service | Rhapsody Hospitality Development Center
@endsection
    ...
    >
      <div class="container z-index-common">
        <div class="breadcumb-content">
          <h1 class="breadcumb-title" data-aos="fade-right" data-aos-duration="1000">Bar & Service</h1>
    ...
    <div class="container">
        <div id="carouselExampleIndicators" class="carousel slide">
            ...
            <div class="carousel-inner mega-hover course-img" data-aos="fade-up"
                ...
                <div class="carousel-item active">
                    <img src="/img/course/fb-service3.jpg" class="d-block w-100" alt="fb-service1">
                </div>
                <div class="carousel-item">
                    <img src="/img/course/fb-service4.jpg" class="d-block w-100" alt="fb-service2">
                </div>
                <div class="carousel-item">
                    <img src="/img/course/fb-service2.jpg" class="d-block w-100" alt="fb-service3">
                </div>
                <div class="carousel-item">
                    <img src="/img/course/fb-service5.jpg" class="d-block w-100" alt="fb-service4">
                </div>
                <div class="carousel-item">
                    <img src="/img/course/fb-service1.jpg" class="d-block w-100" alt="fb-service5">
                </div>
            </div>
        ...
        <div class="row flex-row-reverse">
            ...
            <div class="col-lg-8">
                ...
                <h2 class="course-title" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="50">Bar & Service</h2>
                ...
                <p data-aos="fade-right" data-aos-duration="1000" data-aos-delay="150">
                    ...
                    diperlukan untuk sukses dalam seni bartending dan pelayanan yang
                    berkualitas tinggi. peserta akan mendalami berbagai aspek teoritis
                    dalam pembuatan minuman, pengenalan berbagai jenis minuman dan
                    bahan-bahan, teknik penyajian, serta pelayanan pelanggan yang
                    unggul. Mereka juga akan memahami tata cara pengelolaan bar yang
                    efisien dan kebijakan keamanan minuman. Komponen teori ini
                    memberikan dasar yang kokoh bagi peserta agar dapat menjadi
                    bartender dan pelayan yang terampil, dan juga pelatihan bahasa
                    inggris industri perhotelan.
                </p>
