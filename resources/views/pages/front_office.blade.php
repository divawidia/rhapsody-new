...
@section('title')
    Front Office | LPK Rhapsody Hospitality Development Center
@endsection
    ...
    >
      <div class="container z-index-common">
        <div class="breadcumb-content">
          <h1 class="breadcumb-title"data-aos="fade-right" data-aos-duration="1000">Front Office</h1>
        ...
        <div class="row flex-row-reverse gx-50">
            <div class="col-lg-8">
                <div id="carouselExampleIndicators" class="carousel slide">
                    ...
                    <div class="carousel-inner mega-hover course-img" data-aos="fade-up"
                        ...
                        <div class="carousel-item active">
                            <img src="/img/course/fo1.jpg" class="d-block w-100" alt="front-office1">
                        </div>
                        <div class="carousel-item">
                            <img src="/img/course/fo2.jpg" class="d-block w-100" alt="front-office2">
                        </div>
                    </div>
                ...
                <h2 class="course-title" data-aos="fade-up"
                    data-aos-duration="1000" data-aos-delay="100">Front Office</h2>
                ...
                <div class="" data-aos="fade-up"
                    ...
                    <p>
                        Receptionist / Front Office merupakan mata kuliah dan tempat
                        pelatihan bagaimana tatacara pelayanan public hospitality.
                        Mahasiswa akan mempelajari teori dasar dan praktik langsung dengan
                        beberapa basic skill di front office yang di butuhkan di dunia industri pariwisata saat ini.
                    </p>
                </div>
                <div class="" data-aos="fade-up"
                     data-aos-duration="1000" data-aos-delay="200">
