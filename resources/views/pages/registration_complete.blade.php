    ...
    >
        <div class="container z-index-common space-bottom">
            <div class="text-center breadcumb-content">
                <img src="/img/icon/check.svg" width="250px" alt="check">
                <h1 class="breadcumb-title">Pendaftaran Berhasil</h1>
                <p class="breadcumb-text" style="font-size: 18px">Selamat, kamu sudah menyelesaikan proses pendaftaran online. Tim Rhapsody Hospitality Development Center akan segera menghubungi kamu melalui email/whatsapp maksimal 3 x 24 jam.</p>
