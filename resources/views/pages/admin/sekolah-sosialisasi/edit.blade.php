                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" type="text" autocomplete="off" name="nama_sekolah"
                                           id="nama_sekolah" placeholder="Isikan nama sekolah" value="{{ $item->nama_sekolah }}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" type="text" autocomplete="off" name="alamat_sekolah"
                                           id="alamat_sekolah" placeholder="Isikan alamat sekolah" value="{{ $item->alamat_sekolah }}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" type="text" autocomplete="off" name="kecamatan" id="kecamatan"
                                           placeholder="Isikan kecamatan sekolah" value="{{ $item->kecamatan }}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" autocomplete="off" name="kabupaten" id="kabupaten"
                                           placeholder="Isikan kabupaten sekolah" value="{{ $item->kabupaten }}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" type="tel" autocomplete="off" name="no_hp_wa" id="no_hp_wa"
                                           placeholder="Isikan No. Kontak Sekolah" value="{{ $item->no_hp_wa }}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" type="text" autocomplete="off" name="google_maps" id="google_maps"
                                           placeholder="Isikan Link Google Maps Sekolah" value="{{ $item->google_maps }}">
                                </div>
                            </div>
