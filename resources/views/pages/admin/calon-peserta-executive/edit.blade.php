...
@section('body')
    ...
    @endsection
    @section('content')
        <x-cards.form :route="route('calon-peserta-executive.update', $peserta->id)" :editForm="true" title="Edit Data Calon Peserta : {{ $peserta->nama_lengkap }}" :backBtn="route('calon-peserta-executive.index')">
            <div class="row">
                <div class="col-md-6">
