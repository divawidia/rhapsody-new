                ...
                <form action="{{ route('company.update', ['company' => $company]) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Edit Data Perusahaan Lulusan Alumni</h4>
                        </div>
                        <div class="card-body">
                            <div class="mb-3">
                                <label for="name" class="col-form-label">Nama Perusahaan</label>
                                <input class="form-control" type="text" name="name" id="name" placeholder="Isikan nama perusahaan" value="{{ $company->name }}" required>
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" name="url" id="url" value="{{ $company->url }}" required>
                                @error('url')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <img id="preview_logo" class="image-preview mt-3" src="{{ Storage::url($company->company_logo_url) }}" alt="Icon"/>
