...
@endpush
@section('page-title')
    Tambah Prospek Lowongan Perusahaan
@endsection
...
@section('body')
    ...
    @section('content')
        <div class="row">
            <div class="col-12">
                <form action="{{ route('career-company.store', $pelatihan->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-xl-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" name="company_name" id="company_name" placeholder="Isikan nama perusahaan" value="{{ old('company_name') }}" required>
                                @error('company_name')
                            ...
                            <div class="mb-3">
                                ...
                                <img id="preview_company_logo" class="w-50 image-preview mt-3" src="" alt="Icon"/>
                                @error('btn_icon')
                                <div class="alert alert-danger mt-2">{{ $message }}</div>
                                @enderror
                            </div>
