...
@section('body')
    ...
    @section('content')
        <div class="row">
            <div class="col-12">
                <form action="{{ route('testimoni.update', ['testimoni' => $testimoni]) }}" method="post" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="row">
                        <div class="col-xl-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" name="name" id="name" placeholder="Isikan nama siswa/alumni" value="{{ $testimoni->name }}" required>
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" name="company" id="company" value="{{ $testimoni->company }}" required>
                                @error('company')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" name="position" id="position" value="{{ $testimoni->position }}" required>
                                @error('position')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" name="onboard_year" id="onboard_year" value="{{ $testimoni->onboard_year }}" required>
                                @error('onboard_year')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <textarea class="form-control ckeditor" name="testimony" id="testimony" required>{{ $testimoni->testimony }}</textarea>
                                @error('testimony')
                            ...
                            <div class="mb-3">
                                ...
                                <img id="preview_photo" class="image-preview mt-3" src="{{ Storage::url($testimoni->photo_url) }}" alt="Icon"/>
                                @error('photo_url')
                                <div class="alert alert-danger mt-2">{{ $message }}</div>
                                @enderror
                            </div>
