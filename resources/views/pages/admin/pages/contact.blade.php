        ...
        <form action="{{ route('contact-page-update') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-xl-6 d-flex justify-content-end my-3">
                    ...
                    <a href="{{ route('contact') }}" class="btn btn-primary"><i class="fa-solid fa-up-right-from-square me-2"></i>Open URL</a>
                </div>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                                ...
                                <div>
                                    ...
                                    <div class="mb-3">
                                        <label for="google_maps" class="col-form-label">Google Maps URL</label>
