    ...
    <div data-simplebar class="sidebar-menu-scroll">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li class="menu-title" data-key="t-articles">Calon Peserta Latih</li>
                <li>
                    <a href="{{ route('calon-peserta-diploma.index') }}">
                        <i class='bx bx-group icon nav-icon' ></i>
                        <span class="menu-item" data-key="t-posts">Calon Peserta Diploma</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('calon-peserta-executive.index') }}">
                        <i class='bx bx-group icon nav-icon' ></i>
                        <span class="menu-item" data-key="t-posts">Calon Peserta Executive Program</span>
                    </a>
                </li>
