...
(function () {
    ...
    function setLanguage(lang) {
        document
            .getElementsByClassName("header-lang-img")
            .forEach(function (el) {
                if (el) {
                    switch (lang) {
                        case "eng":
                    ...
                    if (item.href == pageUrl) {
                        ...
                        if (parent && parent.id !== "side-menu") {
                            ...
                            if (parent2 && parent2.id !== "side-menu") {
                                ...
                                if (
                                    parent2.classList.contains("mm-collapsing")
                                ) {
    ...
    function changeDirection(id) {
        if (
            ...
            document
                ...
                .setAttribute("href", "build/css/bootstrap.min.css");
            document
            ...
            document
                .getElementById("app-style")
                .setAttribute("href", "build/css/app.min.rtl.css");
