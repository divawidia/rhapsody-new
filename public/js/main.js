(function ($) {
  ...
  */
  ...
  /*---------- 01. On Load Function ----------*/
    ...
    $(".vs-carousel").each(function () {
        ...
        vsSlide.slick({
            ...
            prevArrow: d("prev-arrow")
                ? prevButton
                : '<button type="button" class="slick-prev"><i class="far fa-angle-left"></i></i></button>',
    ...
    var $validation =
        '[name="name"],[name="email"],[name="number"],[name="subject"],[name="callchoice"],[name="message"]'; // Must be use (,) without any space
