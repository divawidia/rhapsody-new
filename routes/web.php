...
Route::get('/interview', [SiswaSmaSmkController::class, 'landing_page_create'])->name('landing-page');
Route::post('/interview', [SiswaSmaSmkController::class, 'landing_page_store'])->name('landing-page.store');
